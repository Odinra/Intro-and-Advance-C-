...
int main()
{
	...
	//validate the data
	if (sMonth == "January" || sMonth == "March" || sMonth == "May"
		|| sMonth == "July" || sMonth == "August" || sMonth == "October"
		|| sMonth == "December")
	{
		if (dHours > 744)
		{
	...
	else if (sMonth == "April" || sMonth == "June" || sMonth == "September"
		|| sMonth == "November")
	{
		if (dHours > 720)
		{
	...
	{
		cout << "You have entered an incorrect month, please restart"
			" the program";
		exit(0);
	}
